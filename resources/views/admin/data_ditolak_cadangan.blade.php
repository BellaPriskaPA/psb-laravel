...
<head>
    ...
    <title>Ditolak - Admin PSB AQBS</title>
...
<body>
        ...
        <div class="container-fluid px-4">
            <div class="d-flex align-items-center">
                ...
                <div class="lh-1 text-white d-none d-sm-block">
                    ...
                    <small class="opacity-75 fw-medium" style="font-size: 0.6rem;">Ditolak</small>
                </div>
            </div>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="menu-group">
            ...
            <ul class="sub-menu">
                ...
                <li><a href="#" class="active">Ditolak</a></li>
    ...
    <main class="main-content">
        ...
        <div class="info-bar">
            ...
            <div class="info-bar-item">
                <div class="info-icon text-danger" style="background:#fef2f2"><i class="fas fa-user-times"></i></div>
                <div>
                    <span class="info-bar-label">Total Ditolak</span>
                    <span class="info-bar-value text-danger">105 Santri</span>
                </div>
            </div>
        </div>

        <div class="mb-4">
            <h4 class="fw-bold" style="color: var(--navy-primary);">Data Santriwati Ditolak</h4>
            <p class="text-muted small">Daftar calon santriwati yang tidak lolos seleksi penerimaan.</p>
        </div>
        ...
        <div class="filter-card">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select form-select-sm" id="filterAlasan">
                        <option value="">Semua Alasan</option>
                        <option>Nilai Tidak Memenuhi</option>
                        <option>Berkas Tidak Lengkap</option>
                        <option>Hasil Wawancara</option>
                ...
                <table class="simple-data-table" id="simpleDataTable">
                    <thead>
                        <tr>
                            ...
                            <th class="sortable" data-sort="alasan">Alasan</th>
            ...
            <div class="modal-content">
                <div class="modal-header modal-detail-header">
                    <h5 class="modal-title modal-detail-title" id="detailModalLabel">
                        ...
                        <span id="detailTitle">Detail Santri Ditolak</span>
                    </h5>
    ...
    <script>
        ...
        // Generate sample data for ditolak saja
        function generateSampleData(count) {
            ...
            const alasanPenolakan = ["Nilai Tidak Memenuhi", "Berkas Tidak Lengkap", "Hasil Wawancara", "Kuota Penuh"];
            ...
            for (let i = 1; i <= count; i++) {
                ...
                data.push({
                    ...
                    // Data khusus untuk ditolak
                    alasan_penolakan: alasanPenolakan[i % alasanPenolakan.length],
                    catatan: i % 3 === 0 ? "Bisa dipertimbangkan untuk gelombang berikutnya" : 
                             i % 3 === 1 ? "Rekomendasi untuk sekolah lain" : "Tidak memenuhi syarat administrasi",
                    ...
                    tanggal_penolakan: `2026-0${(i % 3 + 1)}-${(i % 28 + 1).toString().padStart(2, '0')}`,
                    nilai_ujian: (60 + Math.random() * 15).toFixed(1)
                });
            }
            return data;
        }
        ...
        // Initial data
        let santriData = generateSampleData(105);
            ...
            return data.sort((a, b) => {
                ...
                switch(currentSortField) {
                    ...
                    case 'jenjang':
                        ...
                        break;
                    case 'alasan':
                        valueA = a.alasan_penolakan;
                        valueB = b.alasan_penolakan;
                        break;
                    case 'id':
                    default:
                        valueA = a.id;
        ...
        function applyFilters() {
            ...
            const alasan = document.getElementById('filterAlasan').value;
            ...
            filteredData = santriData.filter(item => {
                ...
                if (alasan && item.alasan_penolakan !== alasan) return false;
            ...
            setTimeout(() => {
                ...
                if (tahun || gelombang !== "Semua Gelombang" || alasan || search || quickFilter !== 'all') {
                    toastMessage.textContent = `Menampilkan ${filteredData.length} santri yang ditolak`;
                    successToast.show();
                }
            }, 500);
        }
        ...
        function renderSimpleTable(data, startIndex) {
            ...
            data.forEach((item, index) => {
                ...
                row.innerHTML = `
                    ...
                    <!-- Alasan -->
                    <td>${truncateText(item.alasan_penolakan, 20)}</td>
        ...
        function showDetailModal(santri) {
            ...
            const statusBadge = `<span class="status-ditolak"><i class="fas fa-times-circle"></i> ${santri.status}</span>`;
            ...
            modalBody.innerHTML = `
                <div class="detail-grid">
                    ...
                    <!-- Status dan Alasan Penolakan -->
                    <div class="detail-section">
                        <div class="detail-section-title">
                            <i class="fas fa-clipboard-check"></i> STATUS & ALASAN
                        </div>
                        <div class="detail-grid">
                            <div class="detail-item">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">${santri.alasan_penolakan}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Catatan</div>
                                <div class="detail-value">${santri.catatan}</div>
                            </div>
                            <div class="detail-item">
                                <div class="detail-label">Tanggal Penolakan</div>
                                <div class="detail-value">${formatDate(santri.tanggal_penolakan)}</div>
                            </div>
                            <div class="detail-item">
            ...
            detailTitle.textContent = `Detail Santri Ditolak: ${santri.nama}`;
        ...
        function showEditModal(santri) {
                ...
                <form id="editForm">
                    <div class="edit-form-section">
                        <div class="edit-form-section-title">
                            <i class="fas fa-user-graduate"></i> STATUS & ALASAN
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="edit-form-group">
                                    <label class="edit-form-label">Alasan Penolakan</label>
                                    <select class="edit-form-input" id="editAlasan">
                                        <option ${santri.alasan_penolakan === 'Nilai Tidak Memenuhi' ? 'selected' : ''}>Nilai Tidak Memenuhi</option>
                                        <option ${santri.alasan_penolakan === 'Berkas Tidak Lengkap' ? 'selected' : ''}>Berkas Tidak Lengkap</option>
                                        <option ${santri.alasan_penolakan === 'Hasil Wawancara' ? 'selected' : ''}>Hasil Wawancara</option>
                                        <option ${santri.alasan_penolakan === 'Kuota Penuh' ? 'selected' : ''}>Kuota Penuh</option>
                                        <option>Lainnya</option>
                                    </select>
                                </div>
                                <div class="edit-form-group">
                                    <label class="edit-form-label">Tanggal Penolakan</label>
                                    <input type="date" class="edit-form-input" id="editTanggalPenolakan" value="${santri.tanggal_penolakan}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="edit-form-group">
                                    <label class="edit-form-label">Catatan</label>
                                    <textarea class="edit-form-input" id="editCatatan" rows="3">${santri.catatan}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            editTitle.textContent = `Edit Data Santri Ditolak: ${santri.nama}`;
            editModal.show();
        }
        ...
        function saveAllEdits() {
            ...
            currentDetailData.alasan_penolakan = document.getElementById('editAlasan').value;
            currentDetailData.tanggal_penolakan = document.getElementById('editTanggalPenolakan').value;
            currentDetailData.catatan = document.getElementById('editCatatan').value;
        ...
        function printDetailData(santri) {
            ...
            printWindow.document.write(`
                <html>
                <head>
                    <title>Data Santri ${statusText} - ${santri.nama}</title>
                    <style>
                ...
                <body>
                    <div class="header">
                        <h1>DATA SANTRI ${statusText} <span class="status-badge">${santri.status}</span></h1>
                    ...
                    <div class="section">
                        ...
                        <div class="grid">
                            ...
                            <div class="item"><span class="label">Alasan Penolakan:</span> <span class="value">${santri.alasan_penolakan}</span></div>
                            <div class="item"><span class="label">Catatan:</span> <span class="value">${santri.catatan}</span></div>
                            <div class="item"><span class="label">Tanggal Penolakan:</span> <span class="value">${formatDate(santri.tanggal_penolakan)}</span></div>
        ...
        function exportToExcel(dataRange) {
            ...
            const excelData = dataToExport.map(item => ({
                ...
                // Kolom 56-60: Status & Alasan
                'STATUS': item.status,
                'ALASAN_PENOLAKAN': item.alasan_penolakan,
                'CATATAN': item.catatan,
                'TANGGAL_PENOLAKAN': formatDate(item.tanggal_penolakan),
                'NILAI_UJIAN': item.nilai_ujian,
                
                // Kolom 61-65: Informasi Tambahan
                'TAHUN_AJARAN': item.tahun,
                'GELOMBANG': item.gelombang,
                'TANGGAL_PENDAFTARAN': formatDate(item.tanggal_penolakan),
            ...
            XLSX.utils.book_append_sheet(wb, ws, "Data Santri Ditolak");
            
            // Simpan file
            const fileName = `Data_Lengkap_Santri_Ditolak_${new Date().toISOString().split('T')[0]}.xlsx`;
        ...
        // Export to PDF tanpa kolom "Rekomendasi" - Hanya 10 kolom penting
        function exportToPdf(dataRange) {
            ...
            doc.text('DATA SANTRI DITOLAK - PSB AQBS', 20, 20);
            ...
            const tableData = dataToExport.map(item => [
                ...
                item.jenjang,
                item.status,
                truncateText(item.alasan_penolakan, 15),
                formatDate(item.tanggal_penolakan),
                item.nilai_ujian,
                item.jalur_program,
            ...
            setTimeout(() => {
                // Buat tabel
                doc.autoTable({
                    head: [['No', 'Nama', 'NISN', 'Jenjang', 'Status', 'Alasan', 'Tgl Penolakan', 'Nilai', 'Jalur', 'Sekolah Asal']],
                    body: tableData,
                    startY: 40,
                    theme: 'grid',
                    headStyles: {
                    ...
                    columnStyles: {
                        ...
                        5: { cellWidth: 30 }, // Alasan
                        6: { cellWidth: 25 }, // Tgl Penolakan
                        7: { cellWidth: 15 }, // Nilai
                        8: { cellWidth: 20 }, // Jalur
                ...
                // Simpan file
                doc.save(`Data_Santri_Ditolak_${new Date().toISOString().split('T')[0]}.pdf`);
        ...
        function initEventListeners() {
            ...
            document.getElementById('filterAlasan').addEventListener('change', applyFilters);
